    ...
    function create_new_employee(){
        ...
        $result = $employee->new_employee($firstname,$lastname,$contactnumber,$email,$address);
        if($result){
    ...
    function delete_employee()
{
    ...
    function update_employee(){
        ...
        $result = $employee->update_employee($firstname, $lastname, $contactnumber, $email, $id, $address);
        if($result){
            header('location: ../index.php?page=employees&subpage=emplist');
        }
    }
