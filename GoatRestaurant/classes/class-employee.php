...
class Employee{
	...
	public function update_employee($firstname,$lastname,$contactnumber,$email,$id){
		
		$sql = "UPDATE employee SET firstname=:firstname,lastname=:lastname,contactnumber=:contactnumber,email=:email,EmployeeId=:EmployeeId WHERE EmployeeId=:EmployeeId";

		$q = $this->conn->prepare($sql);
		$q->execute(array(':firstname'=>$firstname,':lastname'=>$lastname,':contactnumber'=>$contactnumber,':email'=>$email,':EmployeeId'=>$id));
		return true;
	}
