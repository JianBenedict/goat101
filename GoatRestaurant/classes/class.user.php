...
class User{
	...
	public function new_user($email,$password,$lastname,$firstname,$contactnumber){
	...
	function get_user_id($email){
		$sql="SELECT user_id FROM tbl_admin WHERE user_email = :email";	
		$q = $this->conn->prepare($sql);
	...
	function get_user_email($id){
		$sql="SELECT user_email FROM tbl_admin WHERE user_id = :id";	
		$q = $this->conn->prepare($sql);
		$q->execute(['id' => $id]);
		$user_email = $q->fetchColumn();
		return $user_email;
	...
	// 	$sql="SELECT user_firstname FROM tbl_admin WHERE user_id = :id";	
	// 	$q = $this->conn->prepare($sql);
	// 	$q->execute(['id' => $id]);
	...
	// 	$sql="SELECT user_lastname FROM tbl_admin WHERE user_id = :id";	
	// 	$q = $this->conn->prepare($sql);
	// 	$q->execute(['id' => $id]);
	// 	$user_lastname = $q->fetchColumn();
	// 	return $user_lastname;
	// }
	// function get_user_contactnumber($id){
	// 	$sql="SELECT user_access FROM tbl_admin WHERE user_id = :id";	
	// 	$q = $this->conn->prepare($sql);
	// 	$q->execute(['id' => $id]);
	...
	// 	$sql="SELECT user_status FROM tbl_admin WHERE user_id = :id";	
	// 	$q = $this->conn->prepare($sql);
	// 	$q->execute(['id' => $id]);
